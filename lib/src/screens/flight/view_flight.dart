  ...
  SingleChildScrollView flightViewPage() {
    return SingleChildScrollView(
      ...
      child: Column(children: [
        ...
        SizedBox(height: 20),
        SectionTitle(sectionTitle: 'Flight Details'),
        ...
        displayField(FontAwesomeIcons.clock, 'Arrival Time', flightModels[0].arrivalTime,
            Theme.of(context).primaryColor),
        Padding(padding: const EdgeInsets.only(top: 10, left: 15, right: 15)),
        SectionTitle(sectionTitle: 'Baggage Details'),
        Padding(padding: const EdgeInsets.only(top: 10, left: 15, right: 15)),
        displayCheckboxField('Checked Baggage', checkboxValue: flightModels[0].checkedBaggage),
        Divider(),
        displayCheckboxField('Excess Baggage', checkboxValue: flightModels[0].excessBaggage),
        Padding(padding: const EdgeInsets.only(top: 10, left: 15, right: 15)),
