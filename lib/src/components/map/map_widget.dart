...
class GoogleMapWidgetState extends State<GoogleMapWidget> {
  ...
  /// fetches all markers for accommodation and activity locations belonging
  /// to any of the user's trips
  Future<void> fetchMarkers(String activityType) async {
    final List<SingleTripProvider> trips = Provider.of<TripsProvider>(context, listen: false).trips;
            ...
            for (final AccommodationModel accommodation in accommodations) {
              final marker = Marker(
                ...
                infoWindow: InfoWindow(
                    ...
                    onTap: () {
                      Navigator.pushNamed(context, AccommodationView.route,
  ...
  Widget build(BuildContext context) {
    return Stack(children: <Widget>[
      ...
      FabCircularMenu(
          ...
          children: <Widget>[
            IconButton(icon: Icon(FontAwesomeIcons.home), color: Colors.white, onPressed: () {}),
            IconButton(icon: Icon(FontAwesomeIcons.plane), color: Colors.white, onPressed: () {}),
            IconButton(
