          ...
          child: Container(
            ...
            child: SingleChildScrollView(
              child: Column(children: [
                ...
                Padding(padding: const EdgeInsets.only(top: 10, left: 15, right: 15)),
                fieldView(FontAwesomeIcons.mapMarkerAlt, 'Pick Up Location',
                    rentalCarModels[0].pickupLocation, context),
                Divider(),
                fieldView(FontAwesomeIcons.calendarAlt, 'Pick Up Date',
                ...
                fieldView(FontAwesomeIcons.mapMarkerAlt, 'Return Location',
                    rentalCarModels[0].returnLocation, context),
                Divider(),
                fieldView(FontAwesomeIcons.calendarAlt, 'Return Date',
                ...
                Padding(padding: const EdgeInsets.only(top: 10, left: 15, right: 15)),
                fieldView(FontAwesomeIcons.car, 'Car Description',
                    rentalCarModels[0].carDescription, context),
                Divider(),
                fieldView(FontAwesomeIcons.car, 'Car Number Plate',
