          ...
          child: Container(
            ...
            child: SingleChildScrollView(
              child: Column(children: [
                ...
                Divider(),
                displayField(FontAwesomeIcons.solidBuilding, 'Name', accommodationModels[0].hotelName,
                    context),
                Divider(),
                ...
                Divider(),
                displayField(FontAwesomeIcons.clock, 'Check-In Time',
                ...
                Divider(),
                displayField(FontAwesomeIcons.clock, 'Check-out Time',
