          ...
          child: Container(
            ...
            child: SingleChildScrollView(
              child: Column(children: [
                ...
                Divider(),
                fieldView(FontAwesomeIcons.solidBuilding, 'Company', publicTransportModels[0].company, context),
                Padding(padding: const EdgeInsets.only(top: 10, left: 15, right: 15)),
                SectionTitle('Departure Details'),
                Padding(padding: const EdgeInsets.only(top: 10, left: 15, right: 15)),
                fieldView(FontAwesomeIcons.mapMarkerAlt, 'Departure Location', publicTransportModels[0].departureLocation, context),
                Divider(),
                fieldView(FontAwesomeIcons.calendarAlt, 'Departure Date', publicTransportModels[0].departureDate, context),
                Divider(),
                fieldView(FontAwesomeIcons.clock, 'Departure Time', publicTransportModels[0].departureTime, context),
                Padding(padding: const EdgeInsets.only(top: 10, left: 15, right: 15)),
                SectionTitle('Arrival Details'),
                Padding(padding: const EdgeInsets.only(top: 10, left: 15, right: 15)),
                fieldView(FontAwesomeIcons.mapMarkerAlt, 'Arrival Location', publicTransportModels[0].arrivalLocation, context),
                Divider(),
                fieldView(FontAwesomeIcons.calendarAlt, 'Arrival Date', publicTransportModels[0].arrivalDate, context),
                Divider(),
                fieldView(FontAwesomeIcons.clock, 'Arrival Time', publicTransportModels[0].arrivalTime, context),
                Padding(padding: const EdgeInsets.only(top: 10, left: 15, right: 15)),
                ...
                SectionTitle('Notes'),
                Padding(padding: const EdgeInsets.only(top: 10, left: 15, right: 15)),
                fieldView(FontAwesomeIcons.stickyNote, 'Notes', publicTransportModels[0].notes, context),
                Padding(padding: const EdgeInsets.only(top: 10, left: 15, right: 15)),
                SizedBox(height: 10),
                bottomBar(context),
              ]),
