...
import '../../screens_test/main/profile_page_test.dart';
...
void main() {
  ...
  Future<Widget> makeTestableWidgetForProfilePage({Widget child, BaseAuthService auth}) async {
    ...
    UserModel user = UserModel(
        ...
        photoUrl: 'https://via.placeholder.com/25',
        metadata: metadata);
  ...
  testWidgets('test if page has the select menu widget', (WidgetTester tester) async {
  ...
  testWidgets('test if page has three GestureDetector', (WidgetTester tester) async {
    MockAuth mockAuth = MockAuth();
    ImagePickerHandler _listener;
    AnimationController _controller;
    ImagePickerDialog page = ImagePickerDialog(_listener, _controller);
  ...
  testWidgets('test if page has three FashionFetishTexts', (WidgetTester tester) async {
    MockAuth mockAuth = MockAuth();
    ImagePickerHandler _listener;
    AnimationController _controller;
    ImagePickerDialog page = ImagePickerDialog(_listener, _controller);
      ...
      return MaterialApp(home: Material(child: Builder(builder: (BuildContext context) {
        return Center(
          child: GestureDetector(
            ...
            child: roundedButton('Choose from Library', EdgeInsets.fromLTRB(30.0, 10.0, 30.0, 0.0),
  ...
  testWidgets('test if open Gallery method has ben called', (WidgetTester tester) async {
  ...
  testWidgets('test if open Camera method has ben called', (WidgetTester tester) async {
    final test = MockImagePickerHandler();
  ...
  testWidgets('test if crop image method has ben called', (WidgetTester tester) async {
    final test = MockImagePickerHandler();
