...
void main(){
  test('dateTime gets converted to the right String', () {
    ...
    final result1 = DateConverter.toShortenedMonthString(date1);

    final DateTime date2 = DateTime(2020, 2, 29);
    final result2 = DateConverter.toShortenedMonthString(date2);

    final DateTime date3 = DateTime(2020, 3, 4);
    final result3 = DateConverter.toShortenedMonthString(date3);

    final DateTime date4 = DateTime(2020, 4, 8);
    final result4 = DateConverter.toShortenedMonthString(date4);

    final DateTime date5 = DateTime(2020, 5, 12);
    final result5 = DateConverter.toShortenedMonthString(date5);

    final DateTime date6 = DateTime(2020, 6, 16);
    final result6 = DateConverter.toShortenedMonthString(date6);

    final DateTime date7 = DateTime(2020, 7, 20);
    final result7 = DateConverter.toShortenedMonthString(date7);

    final DateTime date8 = DateTime(2020, 8, 24);
    final result8 = DateConverter.toShortenedMonthString(date8);

    final DateTime date9 = DateTime(2020, 9, 28);
    final result9 = DateConverter.toShortenedMonthString(date9);

    final DateTime date10 = DateTime(2020, 10, 11);
    final result10 = DateConverter.toShortenedMonthString(date10);

    final DateTime date11 = DateTime(2021, 11, 7);
    final result11 = DateConverter.toShortenedMonthString(date11);

    final DateTime date12 = DateTime(2020, 12, 31);
    final result12 = DateConverter.toShortenedMonthString(date12);
